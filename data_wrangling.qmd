...
First, we need to organize and set up our working environment. You need to create a project folder an inside that, you should create 'code' ,' rawdata' and 'figures' folder.
